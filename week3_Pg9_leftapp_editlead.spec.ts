...
//editing lead 
    await page.locator('a[href="/crmsfa/control/viewLead?partyId=10015"]').click();
    await page.locator('a[href="updateLeadForm?partyId=10015"]').click();
    await page.waitForTimeout(7000)
    await page.locator('#updateLeadForm_firstName').clear();
    await page.locator('#updateLeadForm_firstName').fill("vidya");
